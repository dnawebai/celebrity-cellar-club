...
const _auctionsFactory = (iso: (ms: number) => string): Auction[] => [
  ...
  },
  {
    ...
    title: "Finest & Rarest Wines and Spirits · Online",
    category: "mixed",
    location: "London, United Kingdom",
    format: "online",
    startsAtUtc: iso(-4 * DAY),
    endsAtUtc: iso(6 * DAY + 3 * 3_600_000),
    registrationDeadlineUtc: iso(1 * DAY),
    currency: "GBP",
    buyersPremiumPct: 26,
    lotCount: 594,
    coverImage: bottleB,
    summary:
      "Christie's flagship online Wine & Spirits sale: mature Bordeaux, Burgundy grand crus, prestige Champagne and a strong single-cask Scotch and Japanese whisky section from private European cellars.",
    biddingMode: "external",
    partnerUrl:
      "https://www.christies.com/en/search?entry=wine&sortby=relevance&tab=upcoming_auctions",
    status: "live",
    featured: true,
  },
  {
    id: "opus-a-006",
    sourceId: "christies-wine",
    title: "The Cellar of Cornette de Saint Cyr · Part IV",
    category: "wine",
    location: "Paris, France",
    format: "live",
    startsAtUtc: iso(34 * DAY),
    endsAtUtc: iso(34 * DAY + 5 * 3_600_000),
    registrationDeadlineUtc: iso(32 * DAY),
    currency: "EUR",
    buyersPremiumPct: 26,
    lotCount: 412,
    coverImage: bottleG,
    summary:
      "The fourth chapter of one of the most storied private French cellars: Domaine Leroy verticals, Rousseau Chambertin, Coche-Dury Meursault and mature Rhône from the Cornette de Saint Cyr family.",
    biddingMode: "external",
    partnerUrl:
      "https://www.christies.com/en/search?entry=wine&sortby=relevance&tab=upcoming_auctions",
    status: "upcoming",
  },
  {
    id: "opus-a-012",
    sourceId: "christies-wine",
    title: "Finest & Rarest Wines and Spirits · Hong Kong",
    category: "mixed",
    location: "Hong Kong, HK SAR",
    format: "live",
    startsAtUtc: iso(59 * DAY),
    endsAtUtc: iso(60 * DAY + 5 * 3_600_000),
    registrationDeadlineUtc: iso(57 * DAY),
    currency: "HKD",
    buyersPremiumPct: 27,
    lotCount: 728,
    coverImage: bottleC,
    summary:
      "The autumn Asia sale — DRC in depth, Domaine Leflaive, prestige cuvée Champagne magnums and a landmark Karuizawa and Yamazaki 55 whisky section.",
    biddingMode: "external",
    partnerUrl:
      "https://www.christies.com/en/search?entry=wine&sortby=relevance&tab=upcoming_auctions",
    status: "upcoming",
  },
  {
    id: "opus-a-003",
    sourceId: "acker",
    title: "Acker · Hong Kong Auction of Fine & Rare Wine",
    category: "wine",
    location: "Hong Kong, HK SAR",
    format: "live",
    startsAtUtc: iso(10 * DAY),
    endsAtUtc: iso(10 * DAY + 6 * 3_600_000),
    ...
    coverImage: bottleH,
    summary:
      "Opening with 'A Tribute to Michel Rolland — An Offering Direct from Château Le Bon Pasteur', followed by The Immaculate Collection of the Chairman and Pristine Bordeaux Purchased En Primeur.",
    biddingMode: "external",
    partnerUrl: "https://www.ackerwines.com/2026-july-hk-auction/",
    status: "upcoming",
    featured: true,
  },
  {
    id: "opus-a-013",
    sourceId: "acker",
    title: "Acker · Weekly Global Web Auction",
    category: "wine",
    location: "New York, United States",
    format: "online",
    ...
    coverImage: bottleE,
    summary:
      "The recurring global web sale — a broad tranche of Burgundy, Bordeaux, Champagne, Italy and California from small consignor lots, closing every Sunday at 8:00pm ET.",
    biddingMode: "external",
    partnerUrl: "https://www.ackerwines.com/web-auction/",
    status: "live",
  },
  {
    id: "opus-a-014",
    sourceId: "acker",
    title: "Acker · Delaware Auction of Fine & Rare Wine",
    category: "wine",
    location: "Wilmington, Delaware · United States",
    format: "live",
    startsAtUtc: iso(59 * DAY),
    endsAtUtc: iso(59 * DAY + 6 * 3_600_000),
    registrationDeadlineUtc: iso(57 * DAY),
    currency: "USD",
    buyersPremiumPct: 24.5,
    lotCount: 856,
    coverImage: bottleF,
    summary:
      "The autumn Delaware live sale — a deep cross-section of the world's most sought-after wines with a strong Burgundy and Napa cult Cabernet section.",
    biddingMode: "external",
  ...
  },
  {
    id: "opus-a-015",
    sourceId: "acker",
    title: "Acker · Swiss Auction of Fine & Rare Wine",
    category: "wine",
    location: "Zurich, Switzerland",
    format: "live",
    startsAtUtc: iso(122 * DAY),
    endsAtUtc: iso(122 * DAY + 5 * 3_600_000),
    registrationDeadlineUtc: iso(120 * DAY),
    currency: "CHF",
    buyersPremiumPct: 24.5,
    lotCount: 640,
    coverImage: bottleH,
    summary:
      "The November Swiss sale — Grand Cru white Burgundy, Northern Rhône verticals and a rarely-seen tranche of German Riesling from a private Basel cellar.",
    biddingMode: "external",
    partnerUrl: "https://www.ackerwines.com/wine-auctions/",
    status: "upcoming",
  },
  {
    id: "opus-a-004",
    sourceId: "iron-gate",
    title: "Iron Gate · Fine Wine Auction",
    category: "wine",
    location: "Calgary, Alberta · Canada",
    format: "online",
    startsAtUtc: iso(61 * DAY),
    endsAtUtc: iso(68 * DAY + 3 * 3_600_000),
    registrationDeadlineUtc: iso(60 * DAY),
    currency: "CAD",
    buyersPremiumPct: 19.5,
    lotCount: 486,
    coverImage: bottleE,
    summary:
      "Iron Gate's September timed Fine Wine sale — Napa cult Cabernet, Bordeaux verticals, Burgundy Grand Cru and a substantial Barolo section, licensed by Alberta Gaming Liquor and Cannabis.",
    biddingMode: "external",
    partnerUrl:
      "https://bid.irongateauctions.com/auctions/iron-gate-wine/iron-gate-fine-wine-auction-23464",
    status: "upcoming",
  },
  {
    id: "opus-a-008",
    sourceId: "iron-gate",
    title: "Iron Gate · Fine Spirits Auction",
    category: "spirits",
    location: "Calgary, Alberta · Canada",
    format: "online",
    startsAtUtc: iso(60 * DAY),
    endsAtUtc: iso(67 * DAY + 3 * 3_600_000),
    registrationDeadlineUtc: iso(59 * DAY),
    currency: "CAD",
    buyersPremiumPct: 19.5,
    lotCount: 268,
    coverImage: bottleG,
    summary:
      "The companion timed Fine Spirits sale — closed-distillery Scotch, mature Cognac, Japanese single malt and a limited allocation of independent bottlings.",
    biddingMode: "external",
    partnerUrl:
      "https://bid.irongateauctions.com/auctions/iron-gate-wine/iron-gate-fine-spirits-auction-23465",
    status: "upcoming",
  },
  {
    id: "opus-a-016",
    sourceId: "iron-gate",
    title: "Iron Gate · November Fine Spirits Auction",
    category: "spirits",
    location: "Calgary, Alberta · Canada",
    format: "online",
    startsAtUtc: iso(124 * DAY),
    endsAtUtc: iso(131 * DAY + 3 * 3_600_000),
    registrationDeadlineUtc: iso(123 * DAY),
    currency: "CAD",
    buyersPremiumPct: 19.5,
    lotCount: 220,
    coverImage: bottleG,
    summary:
      "The November timed Fine Spirits sale — a broad selection of rare bourbon, aged rum and world whisky from Canadian private cellars.",
    biddingMode: "external",
    partnerUrl:
      "https://bid.irongateauctions.com/auctions/iron-gate-wine/iron-gate-fine-spirits-auction-23467",
    status: "upcoming",
  },
  {
    id: "opus-a-007",
    sourceId: "acker",
    title: "Acker · Piedmont Legends (Completed)",
    category: "wine",
    location: "New York, United States",
    format: "online",
