...
1. [IN PROGRESS] Build the real Dollywood Foundation auction page with dates, items and a separate checkout to the $199 membership.
2. [PENDING] Add several real auction items with start dates to the Dollywood auction page so members can actually bid.
